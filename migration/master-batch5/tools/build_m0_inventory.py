...
产出一个转录物到 POMaster_VNext/migration/master-batch5/：
...
纪律（铁律逐条落实；约定链 master-batch1 → batch2 → batch3 → batch4 扩充不推翻）：
...
OUT_DIR = r"D:\Vscode Documents\po-master\POMaster_VNext\migration\master-batch5"
...
B2_KB = "master-batch2/key-binding-map.batch2.draft.yaml"
...
def collect_migration_evidence(F):
    ...
    m3_mentions = {}
    for b in ("master-batch1", "master-batch2", "master-batch3",
              "master-batch4"):
        ...
        "incidents": [
            {
                ...
                "evidence": [
                    "MIG-B1 已转录：migration/master-batch1/truth/objects/"
        ...
        "incidents": [
            {
                ...
                "evidence": [
                    ...
                    "M3 指针核查（非相关性证据）：migration/master-batch{{1,2,3,4}}/"
...
def build_outputs(cache):
    ...
    inventory = {
        ...
        "provenance_note": (
            ...
            "expires_at）只登记在场布尔不转录值。约定基准：migration/"
            "master-batch1/CONVENTIONS.md → batch2 → batch3 → batch4/"
