...
56 lines per M0 inventory) into SEVEN truth objects, one per SHELL.* slot:
    ...
    -> corpus/master/batch-2/truth/objects/component/shell.<seg>.json
...
Contract (corpus/master/batch-2/CONVENTIONS.md, extends batch1 without
overturning it):
...
def build_envelope(src, nav_overrides, slot, source_digest, nav_digest):
    ...
    escalation = (
        "regenerate via corpus/master/batch-2/tools/ingest_shell_registry.py; "
