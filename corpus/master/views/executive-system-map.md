<!-- view: executive-system-map | generator: corpus/master/tools/build_human_views.py | batch_code: VIEW-M5 | inputs_fingerprint: c0370b23c8c50928f99c607af26a2ee6cd8bbccc2807619521a400b925acdf0d -->
...
>
> 重建：`python corpus/master/tools/build_human_views.py --check`（同输入双跑 byte-stable；inputs_fingerprint=c0370b23c8c50928f99c607af26a2ee6cd8bbccc2807619521a400b925acdf0d）。
...
fingerprint: inputs_fingerprint=c0370b23c8c50928f99c607af26a2ee6cd8bbccc2807619521a400b925acdf0d（消费文件集 relpath+sha256 确定性指纹，明细见 build-manifest.json）
