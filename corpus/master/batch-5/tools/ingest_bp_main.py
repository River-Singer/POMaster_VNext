...
corpus/master/batch-5/CONVENTIONS.md (batch5 adjudication, extends the
...
def build_page_object(ctx, page, task, ctx_ent, states, transitions, bp_ref_res):
    ...
    bp_ref = {
        "batch": "MIG-B2",
        "batch2_object_file": "corpus/master/batch-2/truth/objects/page-surface/"
        + seg + ".json",
    ...
    if dangling_states:
        ...
        payload["dangling_state_refs"] = {
            ...
            "resolution_target": "corpus/master/batch-3/truth/objects/"
    ...
    env = base_envelope(
        ...
        escalation=(
            "regenerate via corpus/master/batch-5/tools/ingest_bp_main.py; "
