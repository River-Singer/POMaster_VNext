...
输入（只读）：
  - corpus/master/batch-4/inventory.yaml               （M0 盘点，10 资产分母同源）
  - corpus/master/batch-4/key-binding-map.batch4.draft.yaml （M0 增量草表，id 列表同源）

输出：
  - corpus/master/batch-4/split-ledger.yaml            （逐条目三选一：UNIVERSAL/PROJECT/HYBRID）
