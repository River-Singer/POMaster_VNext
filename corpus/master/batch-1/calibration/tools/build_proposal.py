...
DOC = {
    ...
    "replay_evidence_base": {
        "samples": "corpus/master/batch-1/calibration/samples.json（16 样本，期望档预注册）",
        "results": "corpus/master/batch-1/calibration/replay-results.json",
        "results_sha256": "7aaafc4a6b4a8e984d0f0d878197d43dde334214a97364d228873821767271a7",
        "replay_log": "corpus/master/batch-1/calibration/replay-round2-input.md",
