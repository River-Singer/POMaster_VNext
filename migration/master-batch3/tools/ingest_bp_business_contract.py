...
pending), one per page-scoped BP business contract:
    ...
    -> migration/master-batch3/truth/objects/business-rule/<page-seg>/<local>.json
...
(migration/master-batch2/truth/objects/page-surface, mechanically derived
...
def build_envelope(
    ...
    notes = (
        ...
        "payload.page_ref=%s（migration/master-batch2/truth/objects/page-surface 对象 id，工具"
    ...
    return {
        ...
        "authority": {
            ...
            "escalation_hint": (
                "regenerate via migration/master-batch3/tools/ingest_bp_business_contract.py; "
