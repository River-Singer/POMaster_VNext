...
AGG-MIG-B4-baseline.json。两侧=项目侧 truth 对象（corpus/master/batch-4/truth/objects/
...
BATCH = VNEXT / "corpus" / "master" / "batch-4"
...
LEDGER_REL = "corpus/master/batch-4/split-ledger.yaml"
