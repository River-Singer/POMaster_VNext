 ...
 *   baseline/manifest.yaml 在场项目须持有效且终结的确认记录（confirmed 块 + 25 文件
 *   确认资产清单 digest 与现盘全等——N1 单一分母，ADR-20 扩 25；pending-change 变更批未终结 =
...
export async function runCloseout(
  ...
  // BASELINE_NOT_CONFIRMED / BASELINE_DRIFT；N1 分母 = 25 文件单一资产清单（ADR-20 扩 25），
