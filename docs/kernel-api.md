...
- 对照测试：packages/kernel/tests/decision-graph.spec.ts（局部 ajv 直载资产正反例 + 八函数全对 + 幂等/反洗白/禁词负例）；allSchemas 挂载计数锚 16→17（discovery-schema/equivalence-schema/knowledge-schema/production/trace 五 spec 同步）。
