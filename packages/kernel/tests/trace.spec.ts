...
describe("16-execution-trace.schema.json", () => {
  it("$id 形态对齐 v1-draft 契约且已注册进 allSchemas（22 份聚合，W1-C 增量 15→16；VB-PR1 增量 16→17；W1-D2 增量 17→18；P-v06 增量 18→19；Batch 1 R3 增量 19→20；Batch 2 R1 增量 20→21；baseline R3 增量 21→22；R1-4 增量 22→23）", () => {
