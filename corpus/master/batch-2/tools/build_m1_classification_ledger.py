...
只读输入：
  - corpus/master/batch-2/inventory.yaml（M0 盘点，分母之家，48 资产）
  - corpus/master/batch-2/key-binding-map.batch2.draft.yaml（页面锚点三方对齐草表）
...
输出：corpus/master/batch-2/classification-ledger.yaml
"""
...
OUT_DIR = r"D:\Vscode Documents\po-master\POMaster_VNext\corpus\master\batch-2"
...
INV_REF = "corpus/master/batch-2/inventory.yaml"
KBM_REF = "corpus/master/batch-2/key-binding-map.batch2.draft.yaml"

DEST_PAGE = "corpus/master/batch-2/truth/objects/page-surface/"
DEST_RULE = "corpus/master/batch-2/truth/objects/business-rule/"
DEST_COMP = "corpus/master/batch-2/truth/objects/component/"
...
def build_meta(entries, conflicts, m, pin_ok):
    ...
    meta = {
        "boundary_clauses": [
            {
                ...
                "carried_from": ("corpus/master/batch-1/classification-ledger.yaml "
        ...
        "generated_by": "corpus/master/batch-2/tools/build_m1_classification_ledger.py",
        "idempotency": {
