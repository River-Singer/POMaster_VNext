...
产出两个转录物到 POMaster_VNext/corpus/master/batch-4/：
...
纪律（铁律逐条落实；约定链 batch-1 → batch-2 → batch-3 扩充不推翻）：
...
OUT_DIR = r"D:\Vscode Documents\po-master\POMaster_VNext\corpus/master/batch-4"
...
def build_outputs(cache):
    ...
    inventory = {
        ...
        "provenance_note": (
            ...
            "约定基准：corpus/master/batch-1/CONVENTIONS.md → "
            "corpus/master/batch-2/CONVENTIONS.md → "
            "corpus/master/batch-3/CONVENTIONS.md（本批扩充不推翻）。"
        ),
    }
