...
产出两个转录物到 POMaster_VNext/migration/master-batch3/：
...
纪律（铁律逐条落实；CONVENTIONS 链 master-batch1 → master-batch2 扩充不推翻）：
...
OUT_DIR = r"D:\Vscode Documents\po-master\POMaster_VNext\migration\master-batch3"
...
def build_outputs(cache):
    ...
    inventory = {
        ...
        "provenance_note": (
            ...
            "migration/master-batch1/CONVENTIONS.md → "
            "migration/master-batch2/CONVENTIONS.md（本批扩充不推翻）。"
        ),
    }
