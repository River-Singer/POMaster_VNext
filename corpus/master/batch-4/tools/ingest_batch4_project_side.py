...
corpus/master/batch-4/split-ledger.yaml into 307 truth objects under
corpus/master/batch-4/truth/objects/<ledger-kind-dir>/<local-name>.json.
...
def build_envelope(cfg, entry_id, decision, ledger_entry, value, index, total,
    ...
    envelope = {
        ...
        "authority": {
            ...
            "escalation_hint": (
                "regenerate via corpus/master/batch-4/tools/ingest_batch4_project_side.py; "
