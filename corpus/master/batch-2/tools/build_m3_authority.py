...
Batch2 counterpart of corpus/master/batch-1/tools/build_m3_authority.py
...
Output: corpus/master/batch-2/authority.json
...
KEYBINDING_MAP_REF = "corpus/master/batch-2/key-binding-map.batch2.draft.yaml"
...
def resolve_ref(ref: str):
    ...
    (batch2 sources include corpus/master/batch-2/* refs that live in the
...
def main():
        ...
        map_rows.append(
            {
                ...
                "object_count_denominator": {
                    ...
                    "scope": "corpus/master/batch-2/truth/objects",
    ...
    document = {
        ...
        "generated_by": "corpus/master/batch-2/tools/build_m3_authority.py",
        "consumes": [
            {
                "ref": "corpus/master/batch-2/truth/objects",
                "role": "reverification denominator (actual file walk) + evidence-axis scan corpus",
            },
            {
                "ref": "corpus/master/batch-2/classification-ledger.yaml",
                "role": "authority_owner_candidate source + boundary clause AUTH-RULE-FRONTEND-ONLY (carried from batch1) + conflicts C-01/C-02",
            },
            {
                "ref": "corpus/master/batch-2/inventory.yaml",
        ...
        "reverification": {
            "scope_statement": (
                ...
                "(MASTer refs and corpus-internal refs), key-binding anchors re-checked (file/dir existence, "
            ...
            "denominators": {
                "objects_total": {
                    "value": len(objects),
                    "source": "file walk of corpus/master/batch-2/truth/objects/**/*.json",
                },
                "objects_by_kind": {
            ...
            "check_definitions": [
                {
                    "check": "source_pin_sha256",
                    "definition": "recompute sha256 of each sources[].ref (MASTer-relative first, po-master fallback for corpus/* refs); compare sources[].pin.digest",
                },
                {
                    "check": "binding_source_registry_membership",
        ...
        "statistics": {
            "object_total": {
                "value": len(objects),
                "denominator_source": "actual file count under corpus/master/batch-2/truth/objects (kind-dir closed set)",
            },
            "owner_coverage": {
