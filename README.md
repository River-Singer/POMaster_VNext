...
pomaster doctor        # 工具/MCP 配置探测（P22 起含 oasdiff / import-linter / dependency-cruiser 三机判腿工具；P23 起扩容 c8 / pytest-cov 覆盖率双腿；P24 起扩容 mutmut / StrykerJS 变异测试双腿；缺什么提示装什么）
```
