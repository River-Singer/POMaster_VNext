...
export const SKILL_MANIFEST: readonly SkillSpec[] = [
  ...
  },
  {
    ...
    bodyLines: [
      ...
      "| Acceptance Gap | affects 引用 + --msd-acceptance 申报 | §15 msd 三轴 |",
      ...
      ...commandBlock([
        ...
        "pomaster brainstorm decide <id> --ready --msd-goal <bool> --msd-scope <bool> --msd-acceptance <bool> [--residual <分类>:<陈述>]",
