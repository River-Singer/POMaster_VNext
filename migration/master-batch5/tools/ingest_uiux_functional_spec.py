...
（migration/master-batch5/truth/objects/page-surface/uiux-spec.*.json，
...
BATCH4_INVENTORY_PATH = (
    VNEXT_ROOT / "migration" / "master-batch4" / "inventory.yaml"
)
...
def batch4_overlay_pin(expected_live_digest):
    ...
    inv = load_yaml(BATCH4_INVENTORY_PATH, "master-batch4/inventory.yaml")
...
def cross_batch_registration(page_id, equal_ids, divergent):
    return {
        ...
        "overlay_objects": "KNOWLEDGE.OVERLAY.PAGES.*（migration/master-batch4/"
...
def build_envelope(page, acc, index, total, src, source_digest, equal_ids, divergent):
    ...
    envelope = {
        ...
        "authority": {
            ...
            "escalation_hint": (
                "regenerate via migration/master-batch5/tools/ingest_uiux_functional_spec.py;"
