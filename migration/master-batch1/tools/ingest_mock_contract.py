...
into per-endpoint contract_operation truth objects:
    ...
    -> migration/master-batch1/truth/objects/contract-op/mock.<local>.json
...
def build_envelope(table_entry, scenarios, src, source_digest, openapi_digest, registry_ids,
    ...
    return {
        ...
        "authority": {
            ...
            "escalation_hint": (
                "regenerate via migration/master-batch1/tools/ingest_mock_contract.py; "
        ...
        "payload": {
            ...
            "migration_registration": {
                "ledger_ref": "migration/master-batch1/classification-ledger.yaml",
