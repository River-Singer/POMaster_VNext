...
the relation is a 1:1 function of the row):
  ...
  states[]    455 rows -> POLICY.STATE.<packed segments>   (kind=business_rule)
              -> migration/master-batch3/truth/objects/business-rule/state/
  variables[] 854 rows ->  17 transcribed objects
              ...
              -> migration/master-batch3/state-ownership-pending-registration.yaml
...
def pack_segments(tokens):
    ...
    authority = migration/master-batch1/tools/ingest_change_governance.py
    ...
    sources = [
        {
            ...
            "locator": {
                ...
                "transcription": (
                    ...
                    "migration/master-batch3/state-ownership-pending-registration."
...
def main():
    ...
    manifest = {
        "admission_gate": {
            ...
            "rule": (
                "master-batch3 CONVENTIONS section 2.2/4.3 admission gate: governed "
