        ...
        envelopes.append(
            base_envelope(
                ...
                escalation_hint=(
                    ...
                    "issue-register.yaml and re-run migration/master-batch1/"
...
def build_migration_ledger_envelope(src, rel, live_digest, authority, ledger_rules):
    ...
    payload = {
        ...
        "pointer_file_verdict": {
            ...
            "adjudicated_in": (
                "migration/master-batch1/classification-ledger.yaml "
    ...
    return base_envelope(
        ...
        escalation_hint=(
            ...
            "source-side freeze tombstone, then re-run migration/master-batch1/"
            "tools/ingest_change_governance.py"
        ),
    )
